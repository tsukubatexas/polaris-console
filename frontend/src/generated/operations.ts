...
export const operationRegistry = {
  "generated_at": "2026-07-27T06:41:24+00:00",
  "operations": [
    {
    ...
    },
    {
      ...
      "header_params": [],
      "id": "catalog_loadNamespaceMetadata",
      "method": "GET",
      "mutating": false,
      "path": "/v1/{prefix}/namespaces/{namespace}",
      "path_params": [
    ...
    {
      "description": "Register a view in the given namespace using given metadata file location.",
      "header_params": [],
      "id": "catalog_registerView",
      "method": "POST",
      "mutating": true,
      ...
      "request_schema_name": "RegisterViewRequest",
      "responses": [
        "200",
        "400",
        "401",
    ...
    },
    {
      ...
      "query_params": [
        {
          "description": "The snapshots to return in the body of the metadata via the `snapshots` field. Setting the value to `all` would return the full set of snapshots currently valid for the table. Setting the value to `refs` would load all snapshots referenced by branches or tags.\nDefault if no param is provided is `all`.",
          "location": "query",
          "name": "snapshots",
          "required": false,
          "schema_type": "string"
    ...
    },
    {
      "description": "Return all stored metadata properties for a given namespace",
      "header_params": [],
      "id": "iceberg_loadNamespaceMetadata",
      "method": "GET",
      "mutating": false,
      "path": "/v1/{prefix}/namespaces/{namespace}",
      "path_params": [
    ...
    },
    {
      ...
      "request_schema_name": "RemoteSignRequest",
      "responses": [
        "200",
        "400",
        "401",
  ...
  "polaris_release": "apache-polaris-1.6.0",
  "source_url": "https://github.com/apache/polaris/tree/apache-polaris-1.6.0/spec"
} as const;
